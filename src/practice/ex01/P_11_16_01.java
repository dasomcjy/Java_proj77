...
public class P_11_16_01 {
	...
	public static void main(String[] args) {
		...
		/*
		  	...
		  	// for 이중문 안에다가 if문 넣어서도 할 수 있다~ 해봄 	  	
		...
		for (int i = 0 ; i < arr1.length; i ++) {
			...
			}else if (i == 3) {			//1부터 시작해서 1씩 증가하는데 7의 배수는 저장하지 않도록 저장
		...
		System.out.println(" ==== for 문을 사용해서 내용출력 =====");
				for (int i = 0 ; i < arr1.length; i++) {
		...
		System.out.println("=====Enhanced for 문을 사용해서 내용 출력 ====");
			...
			System.out.println("===Arrays.toString()를 사용해서 내용출력====");
			for ( int[] a : arr1) {
